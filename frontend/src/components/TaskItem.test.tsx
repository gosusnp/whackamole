...
const renderTask = (
  ...
  const { task = mockTask, onUpdate = vi.fn(), onDelete = vi.fn() } = props;
  return render(
    <DeletionProvider>
...
describe('TaskItem', () => {
  ...
  describe('Visual States', () => {
    it('applies recession class for completed tasks', () => {
      ...
      const { container } = renderTask({ task: completedTask });
